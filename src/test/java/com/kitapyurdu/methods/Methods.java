...
public class Methods {
    ...
    public Methods(){
        ...
        //30 saniye içinde aramamı bul, bu süre içinde 3 saniyede bir dene, bulamazsan driverı quit et.
    ...
    public boolean isElementVisible(By by){
        try{
            wait.until(ExpectedConditions.visibilityOfElementLocated(by)); //verilen element sayfadaki yerini alana kadar bekle.
            return  true;
        }
        catch (Exception e){
            return false;
